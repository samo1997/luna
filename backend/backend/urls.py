...
urlpatterns = [
    ...
    path('backend/api/restaurants/', include('apps.restaurant.urls')),
    # path('backend/api/restaurants/category', include('apps.user.urls')),
    # path('backend/api/restaurants/user', include('apps.user.urls')),
    ...
    # path('backend/api/', include('apps.user.urls')),
